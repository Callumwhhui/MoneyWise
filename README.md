...
Welcome to MoneyWise – your financial companion!
Crafted from the ground up by **Code of Duty**, this is a full-stack CRUD web app, designed to revolutionise your financial management.

Let's meet the masterminds behind the scenes:

- [**RyanBullus**](https://github.com/RyanBulluss): Our GitHub maestro and backend extraordinaire.

- [**Callumwhui**](https://github.com/Callumwhhui): The frontend virtuoso, handling CSS, JavaScript, and ensuring a seamless mobile experience.

- [**Viver2nd**](https://github.com/Viver2nd): The multitasking marvel, juggling both frontend and backend.

- [**AgatheLouiseLav**](https://github.com/AgatheLouiseLav): A frontend guru, bringing life to the UI with CSS, JavaScript, and top-notch mobile responsiveness.

MoneyWise simplifies your financial journey by offering a unified platform for planning and organising your fiscal matters. 
